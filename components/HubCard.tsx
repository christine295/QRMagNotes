...
export default function HubCard({
  ...
  return (
    ...
    >
      ...
      {/* Clone action — always visible */}
      <div className="mt-2.5 pt-2.5 border-t border-gray-100">
        <button
          type="button"
          onClick={e => { e.stopPropagation(); setCloneOpen(true) }}
          className="flex items-center gap-2 text-xs font-medium text-stone-400 hover:text-stone-700 transition-colors w-full group"
        >
          ...
          Clone as new list
          <svg className="w-3 h-3 ml-auto text-stone-300 group-hover:text-stone-500 transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
