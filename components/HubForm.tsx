...
type LinkDraft = Omit<HubLink, 'id' | 'hub_id'>
...
const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    themeColor: '#8B5CF6',
    links: [
      { label: 'Spotify Playlist', url: '', sort_order: 0 },
      { label: 'Artist Notes', url: '', sort_order: 1 },
      { label: 'Moon Phase', url: '', sort_order: 2 },
      { label: 'Inspiration', url: '', sort_order: 3 },
      { label: 'Color Palette', url: '', sort_order: 4 },
      { label: 'Process Photos', url: '', sort_order: 5 },
      { label: 'Materials Used', url: '', sort_order: 6 },
      { label: 'Private Notes', url: '', sort_order: 7 },
    ],
  },
]
